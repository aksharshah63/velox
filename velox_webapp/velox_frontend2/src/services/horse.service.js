...
const HorseService = {
  ...
  async fetchHorses(payload) {
    ...
    // return api.get(url);
    return api.get(`https://velox.horse/velox/api/horses/`, { 'headers': { 'Authorization': `Token fefd30b2bf184d75ecd50414451926679e83441e` } });
  ...
  async fetchHorsesStates() {
    ...
    return api.get(`https://velox.horse/velox/api/horses/stats/`, { 'headers': { 'Authorization': `Token fefd30b2bf184d75ecd50414451926679e83441e` } })
  }
};
