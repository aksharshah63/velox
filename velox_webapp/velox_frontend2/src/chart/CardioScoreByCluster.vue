<template>
  <div class="row">
    ...
    <div class="col-lg-10">
      <h5 class="text-center">Cardio Score by Cluster <span><b>{{sum ? sum+' samples' : ''}}</b></span></h5>
...
export default {
  ...
  async mounted() {
    ...
    const chartData = this.CardioScoreByCluster(this.result?.data?.cardio?.cluster)
