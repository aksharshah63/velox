      ...
      <b-colxx xxs="12">
        ...
        >
          ...
          <template slot="video_url" slot-scope="props">
            <video width="220" height="140" :src="props.rowData.video_url" type="video/mp4" controls></video>
          </template>
          ...
          <template slot="cardio_video_url" slot-scope="props">
            <video width="220" height="140" :src="props.rowData.cardio_video_url" type="video/mp4" controls></video>
