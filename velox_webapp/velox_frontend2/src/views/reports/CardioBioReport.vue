    ...
    <div id="report">
        ...
        <div v-else>
            <div class="col-md-12 main-div">
                ...
                <div class="heading">
                    <h1> CARDIO + BIOMECHANICS REPORT</h1>
                </div>
                    ...
                    <table class="table table-bordered responsive">
                        <tbody>
                            <tr>
                                ...
                                <td style="font-size: 18px; vertical-align: middle;">Cardio+Biomechanics Score : {{prob_cardio_bio_model_score ? prob_cardio_bio_model_score : 'Not Available'}}</td>
                            </tr> 
                            <tr>
            ...
            <div class="col-md-12 div2">
                <div class="chart">
                    <h1>Cardio + Biomechanics - Current Model Performance</h1>
                    <div class="row">
                        <div class="col-md-5">
...
export default {
    ...
    async mounted()
    {
        ...
        api.get(`https://velox.horse/velox/api/horses/${this.$route.params.id}/`,{ 'headers': { 'Authorization': `Token fefd30b2bf184d75ecd50414451926679e83441e` } })
            .then(async response=>{
    ...
    methods: 
    {
        download_pdf() 
        {
            const options = {
                margin: 0.1,
                filename: 'Cardio + Bio Report.pdf',
                image: { 
                    type: 'PNG', 
                    quality: 1 
                },
        ...
        chart()
        {
            ...
            .then(response => { 
                temp = response.data?.cardio_biomechanics?.age; 
                this.temp10 = response.data?.cardio_biomechanics?.age.map(item => item.counts);
                ...
                window.bar15 = new Chart(ctx1, chart_type_data);
                ...
                window.bar16 = new Chart(ctx2, chart_type_data2);
                ...
                window.bar17 = new Chart(ctx3, chart_type_data3);
            })
        },
