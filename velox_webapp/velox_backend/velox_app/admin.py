...
from .models import Horse, Measure, User, ImageMeasurement, CountryWeight, MLModelMetadata, ScoreBins
...
class CountryWeight(admin.ModelAdmin):
    pass


@admin.register(ScoreBins)
class ScoreBins(admin.ModelAdmin):
    pass
