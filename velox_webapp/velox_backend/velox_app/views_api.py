...
from .models import Horse, Measure, GCSBlob, User, ImageMeasurement, CountryWeight, MLModelMetadata
...
class HorseAPIView(viewsets.ModelViewSet):
    ...
    def stats(self, request):
        ...
        biomechanics_score_cluster = get_scores_by_clusters(cardio_df, 'biomechanics_cluster',
