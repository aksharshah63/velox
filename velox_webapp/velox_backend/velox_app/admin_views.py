    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            for line in csv_reader:
                ...
                if existing_horses:
                    print(f'skipping horse {name} {date_of_birth}')
                else:
                    horse = Horse.objects.create(name=name, type=type, sex=sex, date_of_birth=date_of_birth, starts=starts,
